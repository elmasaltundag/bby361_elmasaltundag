<?php
    ...
    $kullanici = "root";
    $sifre = "";
    $veritabani = "bby361_elmasaltundag";
    $port = 3306;
...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">VTYS Test Sayfası</h1>
        <p class="lead">Bu sayfa veri tabanına bağlantının kontrol edildiği sayfadır. Bağlantı sorunsuz bir şekilde gerçekleştirilirse test sonucu ekranda görüntülenecektir.</p>
