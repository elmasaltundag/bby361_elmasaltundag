<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT ES.*, YA.yayineviAdi, CONCAT( YZ.yazarAdi,' ', YZ.yazarSoyadi) AS YZAdiSoyadi FROM eser ES, yayinevi YA, yazar YZ WHERE ES.yayineviID = YA.yayineviID AND ES.yazarID = YZ.yazarID");
...
<html lang="en" class="h-100">
  <head>
    ...
    <meta name="author" content="Elmas Altundağ">
