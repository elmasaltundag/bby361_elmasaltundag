...
$sorgu = mysqli_query($baglanti, "SELECT yazarID, CONCAT(yazarAdi, ' ',yazarSoyadi) AS adiSoyadi FROM yazar");
  ...
  <div class="container">
    ...
    <h2>Eser Ekleme Formu</h2>
        <form method="post" action="eser_ekle2.php">
            ...
            <div class="mb-3">
                <label for="formControl2" class="form-label">Eser Sayfa Sayısı</label>
                <textarea class="form-control" id="formControl2" rows="3" name="eserSayfasi"></textarea>
            </div>
            <div class="mb-3">
                <label for="formControl1" class="form-label">Eser Türü</label>
                <input type="text" class="form-control" id="formControl3" name="eserTuru">
            </div>
            <div class="mb-3">
                ...
                <?php while($satir = mysqli_fetch_assoc($sorgu)){?>
                    <option value="<?php echo $satir["yazarID"]?>"><?php echo $satir["adiSoyadi"]?></option>
                 <?php }?>
                </select>
            </div>
