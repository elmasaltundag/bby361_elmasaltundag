<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT ES.*, YA.yayineviAdi, CONCAT( YZ.yazarAdi,' ', YZ.yazarSoyadi) AS YZAdiSoyadi FROM eser ES, yayinevi YA, yazar YZ WHERE ES.yayineviID = YA.yayineviID AND ES.yazarID = YZ.yazarID AND (ES.eserAdi LIKE('%$q%') OR YZ.yazarAdi LIKE('%$q%') OR YZ.yazarSoyadi LIKE('%$q%') OR YA.yayineviAdi LIKE('%$q%'))");
...
<!doctype html>
 <html lang="en" class="h-100">
  <head>
    ...
    <meta name="description" content="HU BBY361">
    <meta name="author" content="Elmas Altundag">
    ...
    <h2>Eser Kayıtları</h2>
      ...
      <p>
          ...
          while($satir = mysqli_fetch_assoc($sorgu)){
              ...
              printf("<b>Yazar Adı:</b> ".$satir["YZAdiSoyadi"]."</br>");
              printf("<b>Yayinevi:</b> ".$satir["yayineviAdi"]."</br>");
              printf("<b>Eser Türü:</b> ".$satir["eserTuru"]."</br>");
              printf("<b>Eser Sayfasayısı:</b> ".$satir["eserSayfasi"]."</br>");
              printf("<hr>");
            }
            ?>
